...
public class FilmeDAO {
	 ...
	 * 
	 * @param filme Encapsula os dados do filme que será adicionado ao repositório
	 *              de dados
	 */
	public void adicionar(Filme filme) {
		// Aqui será inserido o Código para inserir um novo filme na base de dados
	}
	...
	/**
	 * remover: Executa a ação de remover o filme do repositório de dados.
	 * 
	 * @param filme Filme instância do filme que deve ser removido do repositório
	 */
	public void remover(Filme filme) {
		// Aqui será inserido o Código para remover um filme da base de dados
	}

	/**
	 * consultar: Retorna o(s) filme(s) que atende(m) aos critérios de consulta.
	 * 
